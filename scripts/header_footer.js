...
function fillHeader() {
    ...
    <div class="main_menu">
    <div class="logo">
    <a href="index.html"><img class="logo_item" width=250px heigth=300px src="img/Logo.png" alt="Logo"></a>
    </div>
    <div class="menu">
    <div class="menu_left">
...
function fillHeader_1() {
    ...
    <div class="nav_menu_list_item"><a href="catalog_1.html" class="nev_item">Aplle</a></div>
    <div class="nav_menu_list_item"><a href="catalog_2.html" class="nev_item">Samsung</a></div>
    <div class="nav_menu_list_item"><a href="catalog_3.html" class="nev_item">HONOR</a></div>
    <div class="nav_menu_list_item"><a href="catalog_4.html" class="nev_item">Huawei</a></div>
    <div class="nav_menu_list_item"><a href="catalog_5.html" class="nev_item">OnePlus</a></div>
    <div class="nav_menu_list_item"><a href="catalog_6.html" class="nev_item">Google Pixel</a></div>
